								...
								<div class="col-md-3 tb-rght">
									<div class="logo">
										<a href="index.jsp"> <img
											src="assets/image/logo/logo2.png" alt="logo" class="logodark">
										</a>
									</div>
								</div>
								<div class="col-md-9 tb-lef-div text-right">
									<ul>
										<li><a href="login.html"><span> 찜한상품</span></a></li>
										<li><a href="checkout.html"><span> <i
													class="fa fa-shopping-cart"></i> 장바구니
											</span></a></li><li><a href="login.html"><span> <i
