...
$(function() {
    ...
    $(".plus").click(function() {
    	...
    	x = parseInt($(".item-amount").val());
    	$(".item-amount").val(x+1);
    	total = parseInt($("#totalprice").text());
    	$("#totalprice").text(total+1590); // 1590 대신 item-price
                ...
                <div class="wrapper row">
                    ...
                    <div class="details col-md-6">
                        <h3 class="product-title">친환경 잎채소 깻잎 30g</h3> <!-- 제품 이름 item_name -->
                            ...
                            <h3 class="price"><span>1590</span><span>원</span></h3>
                        <div class="action">
                            ...
                            <button class="수량조절기 minus">-</button>
                            	<input type="number" class="item-amount" min="1" max="99" value="1">
                            <button class="수량조절기 plus">+</button>
                            </span>
                            <hr class="col-md-12">
                            <div>총 상품금액</div>
                            <h1 id="tp" class="price"><span id="totalprice">1590</span><span>원</span></h1> <!-- 수량에 따라 값이 변함 -->
