...
$(document).ready(function() {
   ...
   IMP.init('imp15584671');  // ★중요!!  아임포트에 가입시 부여받은 나의 "가맹점 식별코드". // 이 부분은 개인마다 다 다름. 
   ...
   IMP.request_pay({
       ...
       buyer_email : 'abc123@naver.com', // 구매자 email '${requestScope.email}'
       buyer_name : '홍길동',	  // 구매자 이름  '${requestScope.name}'
       buyer_tel : '010-4444-5555',  // 구매자 전화번호 (필수항목) '${requestScope.mobile}'
       buyer_addr : '우리집',  //주소
       buyer_postcode : '01245', // 우편번호
