...
<style>
    ...
    #cartItemMinus, #cartItemPlus, #cartItemDelete {cursor:pointer; width:15px; height:15px" }
</style>
<script>
	$(function(){
		// url 쿼리스트링 제거
...
<body>
	<div class="row">
		<div class="col-md-8">
			<div class="myLeftCtn">
				<form class="myForm text-center" method="" action=""> <!-- 결제기능 하면 결제 폼으로 넘어가게 하기~ -->
					<header>장바구니</header>
	...
	<!-- 배송지 / 결제하기 -->
	<div style="float: right; width:800px; position: absolute; top:80px; right: 200px;">
		<aside>
